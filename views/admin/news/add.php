...
<?php echo html::formOpen('News/Add/',array('id'=>'editNewsForm','enctype'=>'multipart/form-data')); ?>
...
<div class="row">
    <div class="colm left">
        ...
        <div class="form_element">
            <div>Başlık</div>
            <input type="text"  style="font-size: 17px; padding: 10px 5px" value="<?php echo input::get('newsTitle','s');?>" name="newsTitle" placeholder="Haberin başlığı">
        </div>

        <div class="form_element">
            <div>İçerik</div>
            <textarea type="text" placeholder="Haberin içeriği" name="newsBody"><?php echo input::get('newsBody','');?></textarea>
        </div>
    </div>
   ...
   <div class="form_element">
    ...
    <div class="form_element">
        ...
        <select name="showContent" id="showContent">
            ...
            <option <?php if(input::get('showContent','n') == 1): echo 'selected="selected"'; endif; ?>  value="1">Göster
            <option <?php if(input::get('showContent','n') == 2): echo 'selected="selected"'; endif; ?>  value="2">Gösterme
        </select>
 ...
 <div class="form_element" style="margin-top: 20px">
        ...
        <a class="blue_button btn-delete form-update btn-plus btn-red" href="<?php echo BASEPATH?>News/" value="Güncelle">Iptal</a>
    </div>
